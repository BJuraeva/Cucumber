...
public class CommonMethods extends PageInitializer {
    public static WebDriver driver; // will work when added static key word otherwise we should create the obj of the class
    ...
    public static void openBrowserAndNavigateToURL() {
        ...
        // this method is going to initialize all the objs available inside this method
    ...
    // we can use this method everywhere the code is generic, don't need to start from scratch
    ...
    public static String getTimeStamp(String pattern){
        // it returns current date and time in java
        Date date =new Date();
        // this function sdf used to format the date as per the pattern we are passing
        SimpleDateFormat sdf = new SimpleDateFormat();
        // this line i going return teh formatted date
